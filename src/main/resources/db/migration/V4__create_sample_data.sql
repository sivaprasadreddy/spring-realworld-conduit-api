...
(8, 'One-Stop Guide to Mapping with MapStruct', 'reactive-architecture-with-spring-boot', 'One-Stop Guide to Mapping with MapStruct', 'One-Stop Guide to Mapping with MapStruct https://reflectoring.io/reactive-architecture-with-spring-boot', 1, '2020-01-08'),
