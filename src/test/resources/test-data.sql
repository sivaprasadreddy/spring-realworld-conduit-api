...
(1, 'How (not) to ask for Technical Help?', 'how-to-not-to-ask-for-technical-help', 'Here I would like share my thoughts on what are the better ways to ask for help? and what are some patterns that you should avoid while asking for help.', 'Here I would like share my thoughts on what are the better ways to ask for help? and what are some patterns that you should avoid while asking for help.', 1, CURRENT_TIMESTAMP),
(2, 'Getting Started with Kubernetes', 'getting-started-with-kubernetes', 'In this article we will learn Creating a docker image from a SpringBoot application, Local kubernetes setup using Minikube, Run the SpringBoot app in a Pod, Scaling the application using Deployment, Exposing the Deployment as a Service', 'In this article we will learn Creating a docker image from a SpringBoot application, Local kubernetes setup using Minikube, Run the SpringBoot app in a Pod, Scaling the application using Deployment, Exposing the Deployment as a Service', 1, CURRENT_TIMESTAMP),
(3, 'Few Things I learned in the HardWay in 15 years of my career', 'few-things-i-learned-the-hardway-in-15-years-of-my-career', 'I started my career as a Java developer in 2006, and it is almost 15 years that I have been continuing as a software developer', 'I started my career as a Java developer in 2006, and it is almost 15 years that I have been continuing as a software developer. Along the way I have experienced some amazing things, and a lot of shitty things as well. As I am not a super smart person by birth I ended up learning many things in the HardWay. In this article I would like to share some of my learnings.', 2, CURRENT_TIMESTAMP),
(4, 'Testing REST APIs using Postman and Newman', 'testing-rest-apis-with-postman-newman', 'Testing REST APIs using Postman and Newman', 'Testing REST APIs using Postman and Newman https://sivalabs.in/testing-rest-apis-with-postman-newman', 1, CURRENT_TIMESTAMP),
(5, 'Why SpringBoot?', 'why-springboot', 'Why SpringBoot?', 'https://sivalabs.in/why-springboot', 1, CURRENT_TIMESTAMP),
(6, 'Testing SpringBoot Applications', 'spring-boot-testing', 'Testing SpringBoot Applications', 'Testing SpringBoot Applications https://sivalabs.in/spring-boot-testing', 1, CURRENT_TIMESTAMP),
(7, 'Imposing Code Structure Guidelines using ArchUnit', 'impose-architecture-guidelines-using-archunit', 'Imposing Code Structure Guidelines using ArchUnit', 'Imposing Code Structure Guidelines using ArchUnit https://sivalabs.in/impose-architecture-guidelines-using-archunit', 2, CURRENT_TIMESTAMP),
(8, 'One-Stop Guide to Mapping with MapStruct', 'reactive-architecture-with-spring-boot', 'One-Stop Guide to Mapping with MapStruct', 'One-Stop Guide to Mapping with MapStruct https://reflectoring.io/reactive-architecture-with-spring-boot', 1, CURRENT_TIMESTAMP),
(9, 'Getting Started with Spring WebFlux', 'getting-started-with-spring-webflux', 'Getting Started with Spring WebFlux', 'Getting Started with Spring WebFlux https://reflectoring.io/getting-started-with-spring-webflux', 1, CURRENT_TIMESTAMP),
(10, 'Complete Guide to the Immutables Java Library', 'immutables-library', 'Complete Guide to the Immutables Java Library', 'Complete Guide to the Immutables Java Library https://reflectoring.io/immutables-library', 4, CURRENT_TIMESTAMP),
(11, 'Tracing with Spring Boot, OpenTelemetry, and Jaeger', 'spring-boot-tracing', 'Tracing with Spring Boot, OpenTelemetry, and Jaeger', 'Tracing with Spring Boot, OpenTelemetry, and Jaeger https://reflectoring.io/spring-boot-tracing', 2, CURRENT_TIMESTAMP),
(12, 'Laws and Principles of Software Development', 'laws-and-principles-of-software-development', 'Laws and Principles of Software Development', 'Laws and Principles of Software Development https://reflectoring.io/laws-and-principles-of-software-development', 3, CURRENT_TIMESTAMP),
(13, 'Authentication and Authorization in a Node API using Fastify, tRPC and Supertokens', 'authentication-and-authorization-in-a-node-api-using-fastify-trpc-and-supertokens-3cgn', 'Authentication and Authorization in a Node API using Fastify, tRPC and Supertokens', 'Authentication and Authorization in a Node API using Fastify, tRPC and Supertokens https://dev.to/franciscomendes10866/authentication-and-authorization-in-a-node-api-using-fastify-trpc-and-supertokens-3cgn', 1, CURRENT_TIMESTAMP),
(14, 'Golang tutorial series', 'learn-golang-series', 'Golang tutorial series', 'Golang tutorial series https://golangbot.com/learn-golang-series/', 4, CURRENT_TIMESTAMP)
;
